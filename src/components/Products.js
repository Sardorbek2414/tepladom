...
function Products() {
  const { addToCart, addToLikedProducts, likedProducts } = useContext(CartContext);
              ...
              <div className="card-footer d-flex justify-content-between">
                ...
                >
                  <FaRegHeart
                    style={{
                      fontSize: "30px",
                      color: likedProducts.some((item) => item.id === product.id) ? "red" : "#ffb12a",
                      backgroundColor: likedProducts.some((item) => item.id === product.id)
                        ? "#ffb12a"
                        : "transparent",
                      borderRadius: "50%", 
                      width: "44px",
